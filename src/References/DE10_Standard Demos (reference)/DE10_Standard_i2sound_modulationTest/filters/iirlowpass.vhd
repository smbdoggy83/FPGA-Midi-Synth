...
-- Generated on: 2022-04-26 02:26:00
-- -------------------------------------------------------------
...
----------------------------------------------------------------
--Module Architecture: iirlowpass
----------------------------------------------------------------
ARCHITECTURE rtl OF iirlowpass IS
  -- Local Functions
  -- Type Definitions
  TYPE delay_pipeline_type IS ARRAY (NATURAL range <>) OF signed(15 DOWNTO 0); -- sfix16_En15
  -- Constants
  CONSTANT scaleconst1                    : signed(23 DOWNTO 0) := to_signed(12982, 24); -- sfix24_En15
  ...
  CONSTANT coeff_a2_section1              : signed(23 DOWNTO 0) := to_signed(-9630, 24); -- sfix24_En15
  CONSTANT coeff_a3_section1              : signed(23 DOWNTO 0) := to_signed(28791, 24); -- sfix24_En15
  CONSTANT scaleconst2                    : signed(23 DOWNTO 0) := to_signed(11588, 24); -- sfix24_En15
  ...
  CONSTANT coeff_a2_section2              : signed(23 DOWNTO 0) := to_signed(-8596, 24); -- sfix24_En15
  CONSTANT coeff_a3_section2              : signed(23 DOWNTO 0) := to_signed(22180, 24); -- sfix24_En15
  CONSTANT scaleconst3                    : signed(23 DOWNTO 0) := to_signed(10490, 24); -- sfix24_En15
  ...
  CONSTANT coeff_a2_section3              : signed(23 DOWNTO 0) := to_signed(-7782, 24); -- sfix24_En15
  CONSTANT coeff_a3_section3              : signed(23 DOWNTO 0) := to_signed(16975, 24); -- sfix24_En15
  CONSTANT scaleconst4                    : signed(23 DOWNTO 0) := to_signed(9619, 24); -- sfix24_En15
  ...
  CONSTANT coeff_a2_section4              : signed(23 DOWNTO 0) := to_signed(-7135, 24); -- sfix24_En15
  CONSTANT coeff_a3_section4              : signed(23 DOWNTO 0) := to_signed(12843, 24); -- sfix24_En15
  CONSTANT scaleconst5                    : signed(23 DOWNTO 0) := to_signed(8924, 24); -- sfix24_En15
  CONSTANT coeff_b1_section5              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section5              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b3_section5              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section5              : signed(23 DOWNTO 0) := to_signed(-6620, 24); -- sfix24_En15
  CONSTANT coeff_a3_section5              : signed(23 DOWNTO 0) := to_signed(9548, 24); -- sfix24_En15
  CONSTANT scaleconst6                    : signed(23 DOWNTO 0) := to_signed(8370, 24); -- sfix24_En15
  CONSTANT coeff_b1_section6              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section6              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b3_section6              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section6              : signed(23 DOWNTO 0) := to_signed(-6209, 24); -- sfix24_En15
  CONSTANT coeff_a3_section6              : signed(23 DOWNTO 0) := to_signed(6921, 24); -- sfix24_En15
  CONSTANT scaleconst7                    : signed(23 DOWNTO 0) := to_signed(7931, 24); -- sfix24_En15
  CONSTANT coeff_b1_section7              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section7              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b3_section7              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section7              : signed(23 DOWNTO 0) := to_signed(-5883, 24); -- sfix24_En15
  CONSTANT coeff_a3_section7              : signed(23 DOWNTO 0) := to_signed(4841, 24); -- sfix24_En15
  CONSTANT scaleconst8                    : signed(23 DOWNTO 0) := to_signed(7589, 24); -- sfix24_En15
  CONSTANT coeff_b1_section8              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section8              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b3_section8              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section8              : signed(23 DOWNTO 0) := to_signed(-5629, 24); -- sfix24_En15
  CONSTANT coeff_a3_section8              : signed(23 DOWNTO 0) := to_signed(3216, 24); -- sfix24_En15
  CONSTANT scaleconst9                    : signed(23 DOWNTO 0) := to_signed(7329, 24); -- sfix24_En15
  CONSTANT coeff_b1_section9              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section9              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b3_section9              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section9              : signed(23 DOWNTO 0) := to_signed(-5436, 24); -- sfix24_En15
  CONSTANT coeff_a3_section9              : signed(23 DOWNTO 0) := to_signed(1984, 24); -- sfix24_En15
  CONSTANT scaleconst10                   : signed(23 DOWNTO 0) := to_signed(7142, 24); -- sfix24_En15
  CONSTANT coeff_b1_section10             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section10             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b3_section10             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section10             : signed(23 DOWNTO 0) := to_signed(-5297, 24); -- sfix24_En15
  CONSTANT coeff_a3_section10             : signed(23 DOWNTO 0) := to_signed(1096, 24); -- sfix24_En15
  CONSTANT scaleconst11                   : signed(23 DOWNTO 0) := to_signed(7020, 24); -- sfix24_En15
  CONSTANT coeff_b1_section11             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section11             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b3_section11             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section11             : signed(23 DOWNTO 0) := to_signed(-5208, 24); -- sfix24_En15
  CONSTANT coeff_a3_section11             : signed(23 DOWNTO 0) := to_signed(521, 24); -- sfix24_En15
  CONSTANT scaleconst12                   : signed(23 DOWNTO 0) := to_signed(6961, 24); -- sfix24_En15
  CONSTANT coeff_b1_section12             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section12             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b3_section12             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section12             : signed(23 DOWNTO 0) := to_signed(-5163, 24); -- sfix24_En15
  CONSTANT coeff_a3_section12             : signed(23 DOWNTO 0) := to_signed(238, 24); -- sfix24_En15
  -- Signals
