...
-- Generated on: 2022-04-26 01:45:54
-- -------------------------------------------------------------
...
-- First 3-dB Point  : 0.20833
-- Filter Order      : 24
-- Second 3-dB Point : 0.83333
-- -------------------------------------------------------------
...
----------------------------------------------------------------
--Module Architecture: bandstop2
----------------------------------------------------------------
ARCHITECTURE rtl OF bandstop2 IS
  -- Local Functions
  -- Type Definitions
  TYPE delay_pipeline_type IS ARRAY (NATURAL range <>) OF signed(15 DOWNTO 0); -- sfix16_En15
  -- Constants
  CONSTANT scaleconst1                    : signed(23 DOWNTO 0) := to_signed(17198, 24); -- sfix24_En15
  CONSTANT coeff_b1_section1              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section1              : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section1              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section1              : signed(23 DOWNTO 0) := to_signed(-48704, 24); -- sfix24_En15
  CONSTANT coeff_a3_section1              : signed(23 DOWNTO 0) := to_signed(28685, 24); -- sfix24_En15
  CONSTANT scaleconst2                    : signed(23 DOWNTO 0) := to_signed(17198, 24); -- sfix24_En15
  CONSTANT coeff_b1_section2              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section2              : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section2              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section2              : signed(23 DOWNTO 0) := to_signed(53784, 24); -- sfix24_En15
  CONSTANT coeff_a3_section2              : signed(23 DOWNTO 0) := to_signed(29376, 24); -- sfix24_En15
  CONSTANT scaleconst3                    : signed(23 DOWNTO 0) := to_signed(15648, 24); -- sfix24_En15
  CONSTANT coeff_b1_section3              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section3              : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section3              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section3              : signed(23 DOWNTO 0) := to_signed(-42909, 24); -- sfix24_En15
  CONSTANT coeff_a3_section3              : signed(23 DOWNTO 0) := to_signed(21827, 24); -- sfix24_En15
  CONSTANT scaleconst4                    : signed(23 DOWNTO 0) := to_signed(15648, 24); -- sfix24_En15
  CONSTANT coeff_b1_section4              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section4              : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section4              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section4              : signed(23 DOWNTO 0) := to_signed(48443, 24); -- sfix24_En15
  CONSTANT coeff_a3_section4              : signed(23 DOWNTO 0) := to_signed(23494, 24); -- sfix24_En15
  CONSTANT scaleconst5                    : signed(23 DOWNTO 0) := to_signed(14564, 24); -- sfix24_En15
  CONSTANT coeff_b1_section5              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section5              : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section5              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section5              : signed(23 DOWNTO 0) := to_signed(43675, 24); -- sfix24_En15
  CONSTANT coeff_a3_section5              : signed(23 DOWNTO 0) := to_signed(18511, 24); -- sfix24_En15
  CONSTANT scaleconst6                    : signed(23 DOWNTO 0) := to_signed(14564, 24); -- sfix24_En15
  CONSTANT coeff_b1_section6              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section6              : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section6              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section6              : signed(23 DOWNTO 0) := to_signed(-37850, 24); -- sfix24_En15
  CONSTANT coeff_a3_section6              : signed(23 DOWNTO 0) := to_signed(16245, 24); -- sfix24_En15
  CONSTANT scaleconst7                    : signed(23 DOWNTO 0) := to_signed(13829, 24); -- sfix24_En15
  CONSTANT coeff_b1_section7              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section7              : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section7              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section7              : signed(23 DOWNTO 0) := to_signed(39337, 24); -- sfix24_En15
  CONSTANT coeff_a3_section7              : signed(23 DOWNTO 0) := to_signed(14230, 24); -- sfix24_En15
  CONSTANT scaleconst8                    : signed(23 DOWNTO 0) := to_signed(13829, 24); -- sfix24_En15
  CONSTANT coeff_b1_section8              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section8              : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section8              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section8              : signed(23 DOWNTO 0) := to_signed(-33325, 24); -- sfix24_En15
  CONSTANT coeff_a3_section8              : signed(23 DOWNTO 0) := to_signed(11627, 24); -- sfix24_En15
  CONSTANT scaleconst9                    : signed(23 DOWNTO 0) := to_signed(13372, 24); -- sfix24_En15
  CONSTANT coeff_b1_section9              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section9              : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section9              : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section9              : signed(23 DOWNTO 0) := to_signed(35513, 24); -- sfix24_En15
  CONSTANT coeff_a3_section9              : signed(23 DOWNTO 0) := to_signed(10687, 24); -- sfix24_En15
  CONSTANT scaleconst10                   : signed(23 DOWNTO 0) := to_signed(13372, 24); -- sfix24_En15
  CONSTANT coeff_b1_section10             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section10             : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section10             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section10             : signed(23 DOWNTO 0) := to_signed(-29391, 24); -- sfix24_En15
  CONSTANT coeff_a3_section10             : signed(23 DOWNTO 0) := to_signed(7938, 24); -- sfix24_En15
  CONSTANT scaleconst11                   : signed(23 DOWNTO 0) := to_signed(13152, 24); -- sfix24_En15
  CONSTANT coeff_b1_section11             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section11             : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section11             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section11             : signed(23 DOWNTO 0) := to_signed(32881, 24); -- sfix24_En15
  CONSTANT coeff_a3_section11             : signed(23 DOWNTO 0) := to_signed(8388, 24); -- sfix24_En15
  CONSTANT scaleconst12                   : signed(23 DOWNTO 0) := to_signed(13152, 24); -- sfix24_En15
  CONSTANT coeff_b1_section12             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_b2_section12             : signed(23 DOWNTO 0) := to_signed(1975056, 24); -- sfix24_En23
  CONSTANT coeff_b3_section12             : signed(23 DOWNTO 0) := to_signed(8388607, 24); -- sfix24_En23
  CONSTANT coeff_a2_section12             : signed(23 DOWNTO 0) := to_signed(-26707, 24); -- sfix24_En15
  CONSTANT coeff_a3_section12             : signed(23 DOWNTO 0) := to_signed(5614, 24); -- sfix24_En15
  -- Signals
