...
PACKAGE iirlowpass_tb_pkg IS

  -- Type Definitions
  TYPE filter_in_data_log_type IS ARRAY (0 TO 2659) OF std_logic_vector(23 DOWNTO 0);
  TYPE filter_out_type IS ARRAY (0 TO 2659) OF std_logic_vector(47 DOWNTO 0);
...
END iirlowpass_tb_pkg;

PACKAGE BODY iirlowpass_tb_pkg IS
...
-- Counter to generate Addr.
    ...
    ELSIF clk'event and clk = '1' THEN
      IF rdenb = '1' THEN
        IF (addr = TO_UNSIGNED(2659, 12 )) THEN
          addr     <= addr; 
        ELSE
...
-- Done Signal generation.
    ...
    ELSIF (addr = TO_UNSIGNED(2659, 12 )) THEN
      done <= '1'; 
    ELSE
      done <= '0'; 
    END IF;
...
-- -------------------------------------------------------------
--
-- Module: iirlowpass_tb_data
-- Generated by MATLAB(R) 9.11 and Filter Design HDL Coder 3.1.10.
-- Generated on: 2022-04-26 02:26:10
-- -------------------------------------------------------------
...
USE IEEE.std_logic_1164.all;
USE IEEE.numeric_std.ALL;
USE work.iirlowpass_tb_pkg.ALL;

PACKAGE iirlowpass_tb_data IS

  CONSTANT filter_in_data_log_force : filter_in_data_log_type;
  CONSTANT filter_out_expected : filter_out_type;

END iirlowpass_tb_data;

PACKAGE BODY iirlowpass_tb_data IS
...
USE work.iirlowpass_tb_data.ALL;

ENTITY iirlowpass_tb IS

END iirlowpass_tb;


ARCHITECTURE rtl OF iirlowpass_tb IS
  -- -------------------------------------------------------------
  -- Component Declarations
  -- -------------------------------------------------------------
  COMPONENT iirlowpass
  ...
  -- -------------------------------------------------------------
  FOR ALL : iirlowpass
    USE ENTITY work.iirlowpass(rtl);
  ...
  CONSTANT MAX_ERROR_COUNT                : integer := 2660; -- uint32
