...
PACKAGE lowpass1_tb_pkg IS

  -- Type Definitions
  TYPE filter_in_data_log_type IS ARRAY (0 TO 2147) OF std_logic_vector(23 DOWNTO 0);
  TYPE filter_out_type IS ARRAY (0 TO 2147) OF std_logic_vector(48 DOWNTO 0);
...
PACKAGE BODY lowpass1_tb_pkg IS
...
-- Counter to generate Addr.
    ...
    ELSIF clk'event and clk = '1' THEN
      IF rdenb = '1' THEN
        IF (addr = TO_UNSIGNED(2147, 12 )) THEN
          addr     <= addr; 
        ELSE
...
-- Done Signal generation.
    ...
    ELSIF (addr = TO_UNSIGNED(2147, 12 )) THEN
      done <= '1'; 
    ELSE
      done <= '0'; 
    END IF;
...
USE IEEE.std_logic_1164.all;
USE IEEE.numeric_std.ALL;
USE work.lowpass1_tb_pkg.ALL;

PACKAGE lowpass1_tb_data IS

  CONSTANT filter_in_data_log_force : filter_in_data_log_type;
  CONSTANT filter_out_expected : filter_out_type;

END lowpass1_tb_data;

PACKAGE BODY lowpass1_tb_data IS
...
-- Module: lowpass1_tb
-- Generated by MATLAB(R) 9.11 and Filter Design HDL Coder 3.1.10.
-- Generated on: 2022-04-26 01:35:57
-- -------------------------------------------------------------
...
USE work.lowpass1_tb_data.ALL;

ENTITY lowpass1_tb IS

END lowpass1_tb;


ARCHITECTURE rtl OF lowpass1_tb IS
  -- -------------------------------------------------------------
  ...
  CONSTANT MAX_ERROR_COUNT                : integer := 2148; -- uint32
  ...
  SIGNAL filter_out                       : std_logic_vector(48 DOWNTO 0); -- sfix49_En45
  ...
  SIGNAL filter_out_ref                   : std_logic_vector(48 DOWNTO 0); -- sfix49_En45
